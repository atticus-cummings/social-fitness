...
export default function App() {
  ...
  if (sessionTemp === null) {
    ...
    return (
      <Router>
        <Routes>
          <Route path="/" element={sessionTemp.id ? <Home session={JSON.parse(document.cookie)} supabase={supabase} /> : <Login supabase={supabase} />} />
          <Route path="/webpages/profile" element={<ProfilePage session={JSON.parse(document.cookie)} supabase={supabase} />} />
          <Route path="/webpages/upload" element={<Upload session={JSON.parse(document.cookie)} supabase={supabase} />} />
          <Route path="/webpages/followers" element={<Followers session={JSON.parse(document.cookie)} supabase={supabase} />} />
          <Route path="/components/feed" element={<Feed session={JSON.parse(document.cookie)} supabase={supabase} />} />
          <Route path="/register" element={<Register supabase={JSON.parse(document.cookie)}/>}/>
          <Route path="/login" element={<Login supabase={supabase} />} />
          <Route path="/webpages/leaderboard" element={<LeaderBoard session={JSON.parse(document.cookie)} supabase={supabase} />} />
        </Routes>
      </Router>
    );
  }
